                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    children: [
                                      AutoSizeText(
                                        '${controller.data.stats.p2['kd'].value}',
                                      ...
                                      AutoSizeText(
                                        '${controller.data.stats.p2['kills'].displayValue}',
                                        textAlign: TextAlign.center,
                                        style: TextStyle(
                                            color: myColors.blueLight,
                                            fontSize: 23,
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    children: [
                                      AutoSizeText(
                                        '${controller.data.stats.p2['winRatio'].value}%',
                                        textAlign: TextAlign.center,
                                        style: TextStyle(
                                            color: myColors.blueLight,
                                            fontSize: 23,
                                      ...
                                      AutoSizeText(
                                        '${controller.data.stats.p2['top1'].value}',
                                        textAlign: TextAlign.center,
                                        style: TextStyle(
                                            color: myColors.blueLight,
                                            fontSize: 23,
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  width: constraints.maxWidth * 0.5,
                                  child: AutoSizeText(
                                    '${controller.data.stats.p2['top5'].value}',
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  width: constraints.maxWidth * 0.5,
                                  child: AutoSizeText(
                                    '${controller.data.stats.p2['top12'].value}',
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        color: myColors.purpleBg,
                                        fontSize: 38,
